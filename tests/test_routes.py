...
class TestProductRoutes(TestCase):
    ...
    def test_get_product(self):
        """It should get a product via a GET call by the id"""
    ...
    def test_update_product(self):
        ...
        # step 2: change description of the product
        description = 'this is a description'
        new_product = response.get_json()
        new_product["description"] = description

        # step 3: update the product with a post request
    ...
    def test_update_product_not_found(self):
        ...
        empty_product = {}
        response = self.client.post(f"{BASE_URL}/0", json=empty_product)
        self.assertEqual(response.status_code, status.HTTP_404_NOT_FOUND)
        data = response.get_json()
        self.assertIn("was not found", data["message"])
    ...
    def test_list_products_by_category(self):
        """It should list all products with a given category"""
    ...
    def test_list_products_by_availability(self):
        """It should list all products with a given availability"""
        products = self._create_products(10)
